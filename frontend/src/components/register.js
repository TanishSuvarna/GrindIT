...
const register = ({setisSignUp , handleSubmit,handleIt,setAllInputs ,allInputs}) => {
  return (
    <div>
    <div class="main_container">
            ...
            <h1 class="register_heading">Create Account</h1>
                <form action="" class="register_form" onSubmit={handleSubmit}>
                    <div class="container_form"> 
                        <div class="left_form">
                            <div class="register_box_container">
                                ...
                                <div class="register_box">
                                    <input class="inputs" type="text" value={allInputs.name} onChange={handleIt} placeholder="Name" name="name" id=""/>
                                </div>
                            </div>
                            <div class="register_box_container">
                        ...
                        <input class="inputs" type="password" value={allInputs.password} onChange={handleIt} placeholder="password" name="password" id=""/>
                            ...
                            <div class="register_box_container">
                                ...
                                <div class="register_box">
                                <input class="inputs" type="text" value={allInputs.password} placeholder="Renter password" name="none" id=""/>
                        ...
                        <div class="division">
                          ...
                          <div class="right_form">
                            <div class="register_box_container">
                                ...
                                <div class="register_box">
                                    <input class="inputs" type="number" value={allInputs.phoneNumber} onChange={handleIt} placeholder="PhoneNumber" name="phoneNumber" id=""/>
                                </div>
                            </div>
                            <div class="register_box_container">
                                <label for="">Leetcode Username</label>
                                <div class="register_box">
                                    <input class="inputs" type="text" value={allInputs.leetCodeId} onChange={handleIt}placeholder="Leetcode" name="leetCodeId" id=""/>
                                </div>
                            </div>
                            <div class="register_box_container">
                                <label for="">HackerRank username</label>
                                <div class="register_box"> 
                                    <input class="inputs" type="text" value={allInputs.hackerRankId} onChange={handleIt}placeholder="HackerRank" name="hackerRankId" id=""/>
                                </div>
                            </div>
                            <div class="register_box_container">
                                <label for="">Code Ninja username</label>
                                <div class="register_box">
                                    <input class="inputs" type="text" value={allInputs.codeNinjaId} onChange={handleIt}placeholder="CodeNinja" name="codeNinjaId" id=""/>
                    ...
                    <p style = {{color: "white"}} >Already have an account? <span style ={{color:"blue" , cursor:"pointer"}} onClick ={() => setisSignUp(false)}>Login Here</span></p>
                </form>
        </div>
